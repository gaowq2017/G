...
class det_rec_functions(object):
    ...
    def __init__(self, image, use_large=False):
        self.img = image.copy()
        self.det_file = r'E:\PaddleOCR\checkpoint\save\OCRV4_det.onnx'
        self.small_rec_file = r'E:\PaddleOCR\checkpoint\save\OCRV4_rec.onnx'
        self.large_rec_file = r'E:\PaddleOCR\checkpoint\save\OCRV4_rec.onnx'
        ...
        self.postprocess_op = process_pred(r'E:\TRT\PytorchOCR\torchocr\utils\dict/chinese_cht_dict.txt', 'ch', True)
...
if __name__=='__main__':
    # 读取图片
    image = cv2.imread(r'D:\data\data\0\temp.jpg')
    # OCR-检测-识别
