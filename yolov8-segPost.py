...
class YOLOSeg:
    ...
    def extract_boxes(self, box_predictions):
        ...
        boxes = self.rescale_boxes(boxes, (640, 640), (self.img_height, self.img_width))
...
if __name__ == '__main__':
    ...
    model_path = r"E:\TRT\ultralytics\checkpoint\yolo11\segment\yolo11s-seg.onnx"

    # Initialize YOLOv8 Instance Segmentator
    yoloseg = YOLOSeg(model_path, conf_thres=0.3, iou_thres=0.5)
    img = cv2.imread(r'E:\JDL_InstanceSegmentation\testData\3channel_image\bus.jpg')
